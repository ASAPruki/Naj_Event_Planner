...
while ($row = $result->fetch_assoc()) {
    ...
    if (!isset($row['financial_id'])) {
        // Default values for the payments, without them, the website will crash since these values can't be null
        $full_price = 0;
        $deposit_amount = 0;
...
<head>
    ...
    <link rel="stylesheet" href="../admin-styles/financial.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">

    <script src="../admin-scripts/financial.js"></script>
</head>
